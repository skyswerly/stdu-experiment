...
MainWindow::MainWindow(QWidget* parent)
    : QWidget(parent)
{
    setWindowTitle("memory-management");
    resize(960, 720);
...
void MainWindow::setupUI() {
    ...
    //信号 / 槽连接
    connect(m_applyBtn,  &QPushButton::clicked, this, &MainWindow::onApplyParams);
    connect(m_startBtn,  &QPushButton::clicked, this, &MainWindow::onStartSimulation);
    connect(m_clearBtn,  &QPushButton::clicked, this, &MainWindow::onClearTable);
...
// 辅助函数：刷新地址表格
void MainWindow::refreshAddressTable() {
    const auto& addresses = m_addressGen.getAddresses();
    int pageSize = m_pageSizeSpin->value();
